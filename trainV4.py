...
def main(args):
    ...
    # if args.dataset == "cardiac":
    #     data_path = r"./dataset/ACDC/database/training"
    ...
    for epoch in trange(args.max_epoch):
        ...
        for idx, data in enumerate(train_loader):
            ...
            i_0_a1 = reg_model_bilin([image0, flow_0_a1.float()])

            if alpha2 < 0.5:
                flow_0_a2 = flow_0_1 * alpha2
                i_0_a2 = reg_model_bilin([image0, flow_0_a2.float()])
                i_unknown_a2 = i_0_a2
            else:
                flow_1_a2 = flow_1_0 * (1 - alpha2)
                i_1_a2 = reg_model_bilin([image1, flow_1_a2.float()])
                i_unknown_a2 = i_1_a2

            flow_1_a3 = flow_1_0 * (1 - alpha3)
            i_1_a3 = reg_model_bilin([image1, flow_1_a3.float()])
